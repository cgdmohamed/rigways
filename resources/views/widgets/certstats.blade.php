<div class="py-4">
    <div class="px-4 sm:px-6 lg:px-8">
        <div>
            <h3 class="text-lg font-medium leading-6 text-gray-900">Certificates in-short</h3>
            <dl
                ...
                <div class="px-4 py-5 sm:p-6">
                    <dt class="text-base font-normal text-gray-900">Vaild</dt>
                ...
                <div class="px-4 py-5 sm:p-6">
                    <dt class="text-base font-normal text-gray-900">Expairing</dt>
                    <dd class="mt-1 flex items-baseline justify-between md:block lg:flex">
                        <div class="flex items-baseline text-2xl font-semibold text-indigo-600">
                            58.16%
                ...
                <div class="px-4 py-5 sm:p-6">
                    <dt class="text-base font-normal text-gray-900">Expaired</dt>
                    <dd class="mt-1 flex items-baseline justify-between md:block lg:flex">
                        <div class="flex items-baseline text-2xl font-semibold text-indigo-600">
                            24.57%
