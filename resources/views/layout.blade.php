      ...
      -->
        ...
        <div class="hidden md:fixed md:inset-y-0 md:flex md:w-64 md:flex-col">
            ...
            <div class="flex min-h-0 flex-1 flex-col bg-gray-800">
                ...
                <div class="flex flex-1 flex-col overflow-y-auto">
                    <nav class="flex-1 space-y-1 px-2 py-4">
                        <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
                        <a href="{{ url('') }}" class="{{ Request::is('/') ? 'bg-gray-900' : '' }}  text-white group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                            <!--
              Heroicon name: outline/home
            ...
            -->
                        ...
                        <a href="#" class="{{ Request::is('team') ? 'bg-gray-900' : '' }} text-gray-300 hover:bg-gray-700 hover:text-white group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                            <!-- Heroicon name: outline/users -->
                        ...
                        <a href="{{ route('projects') }}" class="{{ Request::is('projects') ? 'bg-gray-900' : '' }} text-gray-300 hover:bg-gray-700 hover:text-white group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                        ...
                        <a href="{{ route('rigs') }}" class="{{ Request::is('rigs') ? 'bg-gray-900' : '' }} text-gray-300 hover:bg-gray-700 hover:text-white group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="text-gray-400 group-hover:text-gray-300 mr-3 flex-shrink-0 h-6 w-6">
                        ...
                        <a href="#" class="{{ Request::is('certificates') ? 'bg-gray-900' : '' }} text-gray-300 hover:bg-gray-700 hover:text-white group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="text-gray-400 group-hover:text-gray-300 mr-3 flex-shrink-0 h-6 w-6">
