                        ...
                        <dl class="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <dd class="mt-1 text-sm text-gray-500">                                <span
                                    ...
                                    Mohamed</span> , <span
                                    class="inline-flex rounded-full bg-blue-100 px-2 text-xs font-semibold leading-5 text-blue-800">Mohamed Mostafa</span> , <span
                                    class="inline-flex rounded-full bg-blue-100 px-2 text-xs font-semibold leading-5 text-blue-800">Sayed Ali</span> 
                                </dd>
