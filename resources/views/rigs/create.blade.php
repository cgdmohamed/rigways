...
@section('content')
    <div class="px-4 py-6 sm:px-6 lg:px-8 columns-3">
                    ...
                    <div class="space-y-6 bg-white px-4 py-5 sm:p-6">
                        ...
                        <div>
                            ...
                            <select id="rig_type" name="rig_type"
                                ...
                                <option value="drill">Drill Ship Rig</option>
                                <option value="land">Land Rig</option>
                                <option value="submersible">Submersible Rig</option>
                                <option value="jack-up">Jack-up Rig</option>
                                <option value="platform">Platform Rig</option>
                            ...
                            <fieldset class="mt-4">
                              ...
                              <div class="space-y-4 sm:flex sm:items-center sm:space-y-0 sm:space-x-10">
                                <div class="flex items-center">
                                  <input id="email" name="notification-method" type="radio" checked class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                  <label for="email" class="ml-3 block text-sm font-medium text-gray-700">Relocate</label>
                                </div>
                          
                                <div class="flex items-center">
                                  <input id="sms" name="notification-method" type="radio" class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                  <label for="sms" class="ml-3 block text-sm font-medium text-gray-700">Migration</label>
                                </div>
                          
                                <div class="flex items-center">
                                  <input id="push" name="notification-method" type="radio" class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                  <label for="push" class="ml-3 block text-sm font-medium text-gray-700">Deployed</label>
                                </div>
                              </div>
                            </fieldset>
                          </div>
