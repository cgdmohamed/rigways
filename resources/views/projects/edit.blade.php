        ...
        <form class="" action="/projects/{{ $projects->id }}" method="post">
                    ...
                    <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <select id="location" name="location"
                                ...
                                <option value="{{ $projects->location }}" disabled selected>{{ $projects->location }}
                                </option>
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <select id="manager" name="manager" multiple
                                    class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                    <option value="{{ $projects->manager }}" disabled selected>{{ $projects->manager }}
                                    </option>
            ...
            <div class="pt-5">
                <div class="flex justify-end">
                    ...
                    <button type="submit"
                        class="ml-3 inline-flex justify-center rounded-md border border-transparent bg-indigo-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">Update</button>
                </div>
            </div>
        </form>
    </div>
